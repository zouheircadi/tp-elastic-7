...
Charger le jeu d’essai fourni
```shell
POST  tp_elastic_fct_decay/_bulk
{ "index": { "_id":1}}
...
###### Sans sort
Les scodes des documents sont convenables car au delà de 2000, les scores baissent. Toutefois le tri pourrait être amélioré
```shell
