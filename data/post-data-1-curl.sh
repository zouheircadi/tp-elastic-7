...
curl -XDELETE "http://localhost:9200/hol_devoxxfr_pm1"

curl -XPUT "http://localhost:9200/hol_devoxxfr_pm1" -H 'Content-Type: application/json' -d'
{
  "mappings": 
  {
      "properties" : 
...
curl -XPOST "http://localhost:9200/hol_devoxxfr_pm1/_bulk" -H 'Content-Type: application/json' -d'
{ "index": {  }}
...
{ "index": {  }}
{"code":"ATG","country":"Antigua & Barbuda"}
{ "index": {  }}
...
{ "index": {  }}
{"code":"IOT","country":"British Virgin Island"}
{ "index": {  }}
{"code":"BRN","country":"Brunei"}
{ "index": {  }}
{"code":"BGR","country":"Bulgaria"}
{ "index": {  }}
{"code":"BFA","country":"BurkinaFaso"}
{ "index": {  }}
{"code":"MMR","country":"Burma"}
{ "index": {  }}
...
{ "index": {  }}
{"code":"CPV","country":"CapeVerde"}
{ "index": {  }}
{"code":"CYM","country":"CaymanIslands"}
{ "index": {  }}
...
{ "index": {  }}
{"code":"COG","country":"Congo Democratic Republic"}
{ "index": {  }}
{"code":"COD","country":"Congo Republic of the"}
{ "index": {  }}
{"code":"COK","country":"Cook Islands"}
{ "index": {  }}
{"code":"CRI","country":"CostaRica"}
{ "index": {  }}
...
{ "index": {  }}
{"code":"TLS","country":"EastTimor"}
{ "index": {  }}
{"code":"ECU","country":"Ecuador"}
{ "index": {  }}
{"code":"EGY","country":"Egypt"}
{ "index": {  }}
{"code":"SLV","country":"ElSalvador"}
{ "index": {  }}
